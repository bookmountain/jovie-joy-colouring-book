...
const FALLBACK_FAQS = [
  ...
  { q: 'How long until I get my download?', a: 'The link arrives in your inbox seconds after checkout. You can also download straight from the confirmation page, or grab it again any time from your account.' },
    ...
    <section style={{ padding: '80px 0', background: 'var(--cream-2)' }}>
      <div className="page" style={{ maxWidth: 860 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h2 className="heading" style={{ fontSize: 54, margin: 0 }}>Before you ask</h2>
        </div>
        <div>
          {faqs.map((f, i) => (
            <div key={i} className="card" style={{ marginBottom: 16, padding: 0, overflow: 'hidden' }}>
              <button
                ...
                style={{
                  ...
                  border: 'none', cursor: 'pointer', fontWeight: 800, fontSize: 19,
